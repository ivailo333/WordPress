...
class Apus_Themer_Widget_Single_Image extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_single_image',
            esc_html__('Apus Single Image Widget', 'apus-themer'),
            array( 'description' => esc_html__( 'Show single image', 'apus-themer' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <label for="<?php echo esc_attr($this->get_field_id( 'single_image' )); ?>"><?php esc_html_e( 'Image:', 'apus-themer' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'alt' )); ?>"><?php esc_html_e( 'Alt:', 'apus-themer' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'link' )); ?>"><?php esc_html_e( 'Link:', 'apus-themer' ); ?></label>
...
register_widget( 'Apus_Themer_Widget_Single_Image' );